...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            name='BookInstance',
            fields=[
                ('id', models.UUIDField(default=uuid.UUID('1e2e9681-0a33-426b-972d-9a7141552f9a'), help_text='Unique IF for this particular book across the whole library', primary_key=True, serialize=False)),
